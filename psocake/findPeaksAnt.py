# Find Bragg peaks
from peakFinderMasterAnt import runmaster
from peakFinderClientAnt import runclient as runclientAuto
from utils import *
import h5py
import glob
import numpy as np
...
parser.add_argument("--storeImage", action='store_true', help="Save images in cheetah format")
...
if rank == 0:
    ...
    for i in np.arange(numEvents):
        ...
        if img is not None:
            ...
            break
    if img is None:
        print "Could not find a good image"
        abort = 1
    (dim0, dim1) = img.shape
    ...
    if facility == 'LCLS':
        ...
        #myHdf5.create_dataset("/entry_1/result_1/peak1All", (numJobs, args.maxPeaks), dtype=float, chunks=(1, args.maxPeaks))
        #myHdf5.create_dataset("/entry_1/result_1/peak2All", (numJobs, args.maxPeaks), dtype=float, chunks=(1, args.maxPeaks))
        #myHdf5.create_dataset("/entry_1/result_1/peak3All", (numJobs, args.maxPeaks), dtype=float, chunks=(1, args.maxPeaks))
        #myHdf5.create_dataset("/entry_1/result_1/peak4All", (numJobs, args.maxPeaks), dtype=float, chunks=(1, args.maxPeaks))
        #myHdf5.create_dataset("/entry_1/result_1/peak5All", (numJobs, args.maxPeaks), dtype=float, chunks=(1, args.maxPeaks))
        #myHdf5.create_dataset("/entry_1/result_1/peak6All", (numJobs, args.maxPeaks), dtype=float, chunks=(1, args.maxPeaks))
        ...
        ds_peak1 = myHdf5.create_dataset("/entry_1/result_1/peak1",(0,args.maxPeaks),
                                                 maxshape=(None,args.maxPeaks),
                                                 chunks = (1, args.maxPeaks),
                                                 compression='gzip',
                                                 compression_opts=1,
        ...
        ds_peak2 = myHdf5.create_dataset("/entry_1/result_1/peak2",(0,args.maxPeaks),
                                                 maxshape=(None,args.maxPeaks),
                                                 chunks = (1, args.maxPeaks),
                                                 compression='gzip',
                                                 compression_opts=1,
        ...
        ds_peak3 = myHdf5.create_dataset("/entry_1/result_1/peak3",(0,args.maxPeaks),
                                                 maxshape=(None,args.maxPeaks),
                                                 chunks = (1, args.maxPeaks),
                                                 compression='gzip',
                                                 compression_opts=1,
        ...
        ds_peak4 = myHdf5.create_dataset("/entry_1/result_1/peak4",(0,args.maxPeaks),
                                                 maxshape=(None,args.maxPeaks),
                                                 chunks = (1, args.maxPeaks),
                                                 compression='gzip',
                                                 compression_opts=1,
        ...
        ds_peak5 = myHdf5.create_dataset("/entry_1/result_1/peak5",(0,args.maxPeaks),
                                                 maxshape=(None,args.maxPeaks),
                                                 chunks = (1, args.maxPeaks),
                                                 compression='gzip',
                                                 compression_opts=1,
        ...
        ds_peak6 = myHdf5.create_dataset("/entry_1/result_1/peak6",(0,args.maxPeaks),
                                                 maxshape=(None,args.maxPeaks),
                                                 chunks = (1, args.maxPeaks),
                                                 compression='gzip',
                                                 compression_opts=1,
